<template>
    <div class="home">
        <div class="jumbotron">
            <center>
            <h2 class="display-4">Terms of service</h2>
            </center>
            <center>
                <p><strong>Terms and Conditions</strong></p>
<p>Our Terms and Conditions were last updated on 17.3.2022.</p>
...
<li>
<p><strong>"Company"</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Rentara.</p>
</li>
<li>
<p><strong>"Country"</strong> refers to Rentara.</p>
</li>
<li>
...
<li>
<p><strong>"Website"</strong> refers to Rentara, accessible from [___WEBSITE_URL___]</p>
</li>
<li>
...
<p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email (rentara@nesto.nesto) and include in Your notice a detailed description of the alleged infringement.</p>
...
<p>You can contact our copyright agent via email (rentara@nesto.nesto). Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems appropriate, including removal of the challenged content from the Service.</p>
...
<ul>
<li>By sending us an email: rentara@nesto.nesto</li>
</ul>
<p></p>
            </center>
        </div>
